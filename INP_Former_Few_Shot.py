...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default=r'F:\github\mvtec')  # Replace it with your path.E:\IMSN-LW\dataset\mvtec_anomaly_detection

    # save info
    parser.add_argument('--save_dir', type=str, default='./saved_results')
    parser.add_argument('--save_name', type=str, default='INP-Former-Few-Shot')
